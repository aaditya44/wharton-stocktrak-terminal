...
<title>StockTrak Research Terminal v0.7</title><style>{CSS}</style></head><body>
<header><h1>StockTrak Research Terminal <span style="color:#58a6ff">v0.7</span></h1>
...
<footer>StockTrak Research Terminal v0.7 &middot; Python-generated, single-file, no external assets &middot; data: Yahoo Finance daily bars (cached 2026-09-18), StockTrak scheduled snapshots &middot; built for the Wharton competition practice period</footer>
